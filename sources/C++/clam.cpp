...
*
*/
    std::string clam2_getCustomKey(){

    }
    void clam2_writeToProperty(std::string Property, std::string Replacement){

    }
	std::string clam2_readFromProperty(std::string Property){

	}
	void clam2_createProperty(std::string Property, std::string Replacement){

	}
	int clam2_changeCustomKey(std::string key){
